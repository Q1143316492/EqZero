...
struct FEqZeroCheatToRun
{
	...
	EEqZeroCheatExecutionTime Phase = EEqZeroCheatExecutionTime::OnPlayerPawnPossession;
...
class UEqZeroDeveloperSettings : public UDeveloperSettingsBackedByCVars
{
	GENERATED_BODY()

public:
	UEqZeroDeveloperSettings();
