...
#include "EqZeroGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(EqZeroGameViewportClient)
...
UEqZeroGameViewportClient::UEqZeroGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UEqZeroGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
