...
#include UE_INLINE_GENERATED_CPP_BY_NAME(EqZeroTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UEqZeroTaggedWidget::UEqZeroTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UEqZeroTaggedWidget::NativeConstruct()
{
...
void UEqZeroTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UEqZeroTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UEqZeroTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
