...
// OK CreateHostingRequest 流程调试一下

#pragma once

#include "Engine/DataAsset.h"

#include "EqZeroUserFacingExperienceDefinition.generated.h"
 ...
 * 比如地上摆了几个关卡的入口，上面有一些UI，触碰能跳去某个地图，这个类就描述了这些体验的信息
 * */
UCLASS(BlueprintType)
class EQZEROGAME_API UEqZeroUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="EqZeroExperienceDefinition"))
