...
#include UE_INLINE_GENERATED_CPP_BY_NAME(EqZeroExperienceDefinition)

#define LOCTEXT_NAMESPACE "EqZeroSystem"

UEqZeroExperienceDefinition::UEqZeroExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UEqZeroExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UEqZeroExperienceDefinition::UpdateAssetBundleData()
{
