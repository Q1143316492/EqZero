...
#include "EqNumberPopComponent_MeshText.h"
...
#include "EqDamagePopStyle.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "TimerManager.h"
#include "UObject/Package.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(EqNumberPopComponent_MeshText)

class UStaticMesh;

UEqNumberPopComponent_MeshText::UEqNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UEqNumberPopComponent_MeshText::AddNumberPop(const FEqNumberPopRequest& NewRequest)
{
...
void UEqNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UEqNumberPopComponent_MeshText::DetermineColor(const FEqNumberPopRequest& Request) const
{
	for (UEqDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UEqNumberPopComponent_MeshText::DetermineStaticMesh(const FEqNumberPopRequest& Request) const
{
	for (UEqDamagePopStyle* Style : Styles)
	{
...
void UEqNumberPopComponent_MeshText::SetMaterialParameters(const FEqNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
