...
class AActor;
class UCanvas;
// class UEqZeroCameraComponent; // TODO: Implement unrelated class
...
public:
	...
	// UE_API UEqZeroCameraComponent* GetEqZeroCameraComponent() const; // TODO: Implement unrelated class
...
protected:
	...
	UPROPERTY()
	TArray<TObjectPtr<UEqZeroCameraMode>> CameraModeInstances;

	UPROPERTY()
	TArray<TObjectPtr<UEqZeroCameraMode>> CameraModeStack;
};
