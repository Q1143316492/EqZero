...
#include "EqZeroCosmeticDeveloperSettings.generated.h"
...
class UEqZeroCosmeticDeveloperSettings : public UDeveloperSettingsBackedByCVars
{
	GENERATED_BODY()

public:
	UEqZeroCosmeticDeveloperSettings();
...
public:
	...
	TArray<FEqZeroCharacterPart> CheatCosmeticCharacterParts;
