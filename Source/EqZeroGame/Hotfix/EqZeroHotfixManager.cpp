...
#include "EqZeroHotfixManager.h"
#include "UObject/UObjectIterator.h"
#include "Engine/NetDriver.h"
#include "DeviceProfiles/DeviceProfileManager.h"
#include "DeviceProfiles/DeviceProfile.h"
// TODO: Implement EqZeroSettingsLocal when Settings system is ported
// #include "Settings/EqZeroSettingsLocal.h"
#include "HAL/MemoryMisc.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(EqZeroHotfixManager)

int32 UEqZeroHotfixManager::GameHotfixCounter = 0;

UEqZeroHotfixManager::UEqZeroHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UEqZeroHotfixManager::GetOnScreenMessages);
...
void UEqZeroHotfixManager::Init()
{
	Super::Init();
}

void UEqZeroHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		// TODO: Notify settings system when it's implemented
		// UEqZeroSettingsLocal* GameSettings = UEqZeroSettingsLocal::Get();
...
bool UEqZeroHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UEqZeroHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UEqZeroHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UEqZeroHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UEqZeroHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UEqZeroHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
#if !UE_BUILD_SHIPPING
void UEqZeroHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO: Add hotfix status messages for debugging
}
#endif // !UE_BUILD_SHIPPING

void UEqZeroHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UEqZeroHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
