...
#include "EqZeroEditorEngine.generated.h"
...
UCLASS()
class UEqZeroEditorEngine : public UUnrealEdEngine
{
	GENERATED_BODY()

public:

	UEqZeroEditorEngine(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
